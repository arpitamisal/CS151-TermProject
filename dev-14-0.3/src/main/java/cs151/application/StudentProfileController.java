...
public class StudentProfileController {
    ...
    private void setupRadioButtons() {
        ...
        employedRadio.selectedProperty().addListener((observable, oldVal, newVal) -> {
    ...
    private void setupCheckBoxes() {
        ...
        whitelistCheck.selectedProperty().addListener((observable, oldVal, newVal) -> {
            if (newVal && blacklistCheck.isSelected()) {
                blacklistCheck.setSelected(false);
            }
        });
        
        blacklistCheck.selectedProperty().addListener((observable, oldVal, newVal) -> {
